 ...
 */
const ListingsController = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: ListingsController.url(options),
    method: 'get',
})

ListingsController.definition = {
    methods: ["get","head"],
    url: '/admin/listings',
 ...
 * @route '/admin/listings'
 */
ListingsController.url = (options?: RouteQueryOptions) => {
    return ListingsController.definition.url + queryParams(options)
}
 ...
 * @route '/admin/listings'
 */
ListingsController.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: ListingsController.url(options),
    method: 'get',
})
/**
 ...
 * @route '/admin/listings'
 */
ListingsController.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: ListingsController.url(options),
    method: 'head',
})
 ...
 * @route '/admin/listings'
 */
    const ListingsControllerForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: ListingsController.url(options),
        method: 'get',
    })
 ...
 * @route '/admin/listings'
 */
        ListingsControllerForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: ListingsController.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/admin/listings'
 */
        ListingsControllerForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: ListingsController.url({
    ...
    ListingsController.form = ListingsControllerForm
/**
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\Admin\ListingsController::uploadImages
 * @see app/Http/Controllers/Admin/ListingsController.php:462
 * @route '/admin/listings/{property}/images'
 */
export const uploadImages = (args: { property: number | { id: number } } | [property: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/admin/listings/{property}/images'
 */
uploadImages.url = (args: { property: number | { id: number } } | [property: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { property: args }
    }
 ...
 * @route '/admin/listings/{property}/images'
 */
uploadImages.post = (args: { property: number | { id: number } } | [property: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: uploadImages.url(args, options),
    method: 'post',
})
 ...
 * @route '/admin/listings/{property}/images'
 */
    const uploadImagesForm = (args: { property: number | { id: number } } | [property: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/admin/listings/{property}/images'
 */
        uploadImagesForm.post = (args: { property: number | { id: number } } | [property: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: uploadImages.url(args, options),
            method: 'post',
        })
...
ListingsController.create = create
ListingsController.store = store
ListingsController.edit = edit
ListingsController.uploadImages = uploadImages
ListingsController.update = update
ListingsController.destroy = destroy
