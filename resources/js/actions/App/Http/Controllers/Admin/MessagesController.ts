 ...
 */
const MessagesController = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: MessagesController.url(options),
    method: 'get',
})

MessagesController.definition = {
    methods: ["get","head"],
    url: '/admin/messages',
 ...
 * @route '/admin/messages'
 */
MessagesController.url = (options?: RouteQueryOptions) => {
    return MessagesController.definition.url + queryParams(options)
}
 ...
 * @route '/admin/messages'
 */
MessagesController.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: MessagesController.url(options),
    method: 'get',
})
/**
 ...
 * @route '/admin/messages'
 */
MessagesController.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: MessagesController.url(options),
    method: 'head',
})
 ...
 * @route '/admin/messages'
 */
    const MessagesControllerForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: MessagesController.url(options),
        method: 'get',
    })
 ...
 * @route '/admin/messages'
 */
        MessagesControllerForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: MessagesController.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/admin/messages'
 */
        MessagesControllerForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: MessagesController.url({
    ...
    MessagesController.form = MessagesControllerForm
/**
...
MessagesController.update = update
MessagesController.destroy = destroy
